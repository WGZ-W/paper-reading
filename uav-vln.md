...
|年份|名字|会议/期刊|作者|简介|
|:-:|:-:|:-:|:-:|:-:|
|2023|[AerialVLN](https://arxiv.org/abs/2308.06735)|ICCV 2023|Shubo Liu；Yuankai Qi|首个面向无人机的、室外城市级视觉-语言导航任务|
||[CityNav](https://arxiv.org/abs/2406.14240)|ICCV 2025||（不怎么熟悉）|
||[OpenFly](https://arxiv.org/abs/2502.18041)|ICLR 2026|||
||[LookasideVLN](https://arxiv.org/abs/2604.17190)|CVPR 2026|||
||[OctMem-Agent](https://cvpr.thecvf.com/virtual/2026/oral/40327)|CVPR 2026|||
||[UAV-ON](https://arxiv.org/abs/2508.00288)|ACMMM Dataset Track 2025|||
||[APEX](https://arxiv.org/abs/2602.00551)|CVPR 2026|||
||[OpenUAV（TravelUAV）](https://arxiv.org/abs/2410.07087)|ICLR 2025|Xiangyu Wang, Si Liu |目标导向的数据集（TravelUAV）；基准：UAV-Need-Help|
||[AerialVLA](https://ojs.aaai.org/index.php/AAAI/article/view/38878)|AAAI 2026|Chen, J., Li, H.|优化提问时机（PNaQ）; 时空融合历史信息（HSTF）(STA), 根据坐标拼接全局地图; ANDH and ANDH-Full datasets|
...
- **CityNav: A Large-Scale Dataset for Real-World Aerial Navigation** & Jungdae Lee, Nakamasa Inoue & **** & [(arxiv)]
  - **CityNav数据集**：
  - 地理语义地图（GSM）表示


- **OpenFly: A comprehensive platform for aerial vision-language navigation** & Yunpeng Gao, Bin Zhao. **** & [(arxiv)]
  - **OpenFly平台**：
    - 集成 4 大渲染引擎/技术
    - 全自动数据生成工具链
  - **大规模数据集**：
...
- **Learning Fine-Grained Alignment for Aerial Vision-Dialog Navigation** & & **AAAI 2025** & [HTML](https://ojs.aaai.org/index.php/AAAI/article/view/32758)
...
- **FlyMirage: A Fully Automated Generation Pipeline for Diverse and Scalable UAV Flight Data via Generative World Model** & [Arxiv](https://arxiv.org/abs/2605.19600)


- **Generalization of World Models under Environmental Variability for Vision-based Quadrotor Navigation** & [Arxiv](https://arxiv.org/abs/2606.05015)

- **ImagineUAV: Aerial Vision-Language Navigation via World-Action Modeling and Kinodynamic Planning** & [Arxiv](https://arxiv.org/abs/2606.01205)
...
- **See-and-Reach: Precise Vision-Language Navigation for UAVs within the Field of View** & [Arxiv](https://arxiv.org/abs/2606.20045)

- **Think Like a Pilot: Fine-Grained Long-Horizon UAV Navigation** & [Arxiv](https://arxiv.org/abs/2606.06836)

- **FSD-VLN: Fast-Slow Dual-System Modeling for Aerial Long-Horizon Vision-Language Navigation** & [Arxiv](https://arxiv.org/abs/2607.08359)

- **DynFly: Dynamic-Aware Continuous Trajectory Generation for UAV Vision-Language Navigation in Urban Environments** & [Arxiv](https://arxiv.org/abs/2606.31654)